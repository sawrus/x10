...
Игрок должен видеть, откуда взялись очки.

## Задача для Codex

Создай страницу History: timeline выполнений и изменений баланса, quest title, sphere, score/rate, date.
